 ...
 */
public class ProjectTask extends NabuccoDatatype implements Datatype {
     ...
     * CloneObject.
     *
     * @param clone the ProjectTask.
     */
    protected void cloneObject(ProjectTask clone) {
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(ProjectTask.getPropertyDescriptor(NAME), this.name, null));
        properties.add(super.createProperty(ProjectTask.getPropertyDescriptor(DESCRIPTION), this.description, null));
        return properties;
    }
    ...
    @Override
    public ProjectTask cloneObject() {
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(ProjectTask.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(ProjectTask.class).getAllProperties();
    }
}
